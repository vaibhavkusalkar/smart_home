...
import 'package:smart_home/pages/control_panel/components/option_widget.dart';
import 'package:smart_home/pages/control_panel/options_enum.dart';
import 'package:smart_home/pages/control_panel/components/power_widget.dart';
import 'package:smart_home/pages/control_panel/components/slider/slider_widget.dart';
import 'package:smart_home/pages/control_panel/components/speed_widget.dart';
import 'package:smart_home/pages/control_panel/components/temp_widget.dart';
import 'package:smart_home/utility/slider.dart';
import 'package:smart_home/components/app_bar.dart';
  ...
  Widget options() {
    return Row(
      ...
      children: [
        ...
        OptionWidget(
          icon: 'lib/assets/svg/bright.svg',
